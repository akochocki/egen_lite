...
#["/mnt/home/kochocki/skunk/BFR_TEST/test_bfr_v2_config_backup.yaml"]
...
if os.path.exists('/mnt/scratch/kochocki/SPICE_FTP_V2_Test_Data/VarAuto_Reco_' + args.switch + '_' +  file_num_str + '_' + modelname + '.i3.zst'):
    os.remove('/mnt/scratch/kochocki/SPICE_FTP_V2_Test_Data/VarAuto_Reco_' + args.switch + '_' +  file_num_str + '_' + modelname + '.i3.zst')

if os.path.exists('/mnt/scratch/kochocki/SPICE_FTP_V2_Test_Data/VarAuto_Reco_' + args.switch + '_' +  file_num_str + '_' + modelname + '.hdf5'):
